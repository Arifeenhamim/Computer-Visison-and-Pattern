...
model = load_model(f"D:\AIUB 10th semester/Vision/Assignment-1/mymodel.h5",compile=False)

with open(f'D:\AIUB 10th semester/Vision/Assignment-1/category2label.pkl', 'rb') as cat:
...
face_cascade = cv2.CascadeClassifier(f'D:\AIUB 10th semester/Vision/Assignment-1/haarcascade_frontalface_default.xml')
